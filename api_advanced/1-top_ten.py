...
def top_ten(subreddit):
    ...
    if response.status_code == 404:
        print("OK")  # If subreddit doesn't exist, print OK
        return

    # If the status code is not 404, check if the request was successful (status code 200)
    if response.status_code == 200:
        ...
        print("OK")  # Indicate that the request was successful
